...
public class CosmosDbPupilPremiumDownloadDatasetReadOnlyRepository : IPupilPremiumDownloadDatasetReadOnlyRepository
{
    ...
    public CosmosDbPupilPremiumDownloadDatasetReadOnlyRepository(
