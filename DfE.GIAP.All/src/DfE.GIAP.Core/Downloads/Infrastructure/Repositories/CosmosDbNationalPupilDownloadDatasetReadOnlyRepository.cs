...
public class CosmosDbNationalPupilDownloadDatasetReadOnlyRepository : INationalPupilDownloadDatasetReadOnlyRepository
{
    ...
    public CosmosDbNationalPupilDownloadDatasetReadOnlyRepository(
