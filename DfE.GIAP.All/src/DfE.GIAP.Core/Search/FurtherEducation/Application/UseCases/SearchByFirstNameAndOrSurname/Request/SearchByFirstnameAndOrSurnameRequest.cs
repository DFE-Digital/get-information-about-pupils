...
namespace DfE.GIAP.Core.Search.FurtherEducation.Application.UseCases.SearchByFirstnameAndOrSurname.Request;
...
/// </summary>
public sealed class SearchByFirstNameAndOrSurnameRequest
    : IUseCaseRequest<SearchByFirstNameAndOrSurnameResponse>
{
    /// <summary>
    ...
    public SearchByFirstNameAndOrSurnameRequest(string searchKeyword, int offset = 0)
    {
        if (string.IsNullOrWhiteSpace(searchKeyword))
        {
            throw new ArgumentException("Search keyword must not be null or empty.", nameof(searchKeyword));
        }
    ...
    /// <param name="offset">Offset for pagination (defaults to 0).</param>
    public SearchByFirstNameAndOrSurnameRequest(
