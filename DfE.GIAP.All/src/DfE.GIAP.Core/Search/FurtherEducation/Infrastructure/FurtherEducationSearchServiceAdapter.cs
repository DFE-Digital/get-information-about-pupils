...
/// </summary>
public sealed class FurtherEducationSearchServiceAdapter :
    ISearchServiceAdapter<FurtherEducationPupilSearchResult, FurtherEducationFacets>
{
    private readonly ISearchByKeywordService _searchByKeywordService;
    private readonly IMapper<Pageable<SearchResult<FurtherEducationPupilSearchResult>>, FurtherEducationPupilSearchResult> _searchResultMapper;
    private readonly IMapper<Dictionary<string, IList<FacetResult>>, FurtherEducationFacets> _facetsMapper;
    ...
    public FurtherEducationSearchServiceAdapter(
        ...
        IMapper<Pageable<SearchResult<FurtherEducationPupilSearchResult>>, FurtherEducationPupilSearchResult> searchResultMapper,
        IMapper<Dictionary<string, IList<FacetResult>>, FurtherEducationFacets> facetsMapper,
    ...
    /// </exception>
    public async Task<SearchResults<FurtherEducationPupilSearchResult, FurtherEducationFacets>> SearchAsync(
        SearchServiceAdapterRequest searchServiceAdapterRequest)
    {
        ...
        Response<SearchResults<FurtherEducationPupilSearchResult>> searchResults =
            await _searchByKeywordService.SearchAsync<FurtherEducationPupilSearchResult>(
        ...
        return new SearchResults<FurtherEducationPupilSearchResult, FurtherEducationFacets>
        {
