...
public sealed class AzureSearchFacetResultsToEstablishmentFacetsMapperTests
{
    AzureSearchFacetResultsToEstablishmentFacetsMapper _facetResultToFacetMapper = new();
