...
public class ValidationHelperTests
{
    ...
    public void IsValidUpnLength_Check()
    {
        ...
        // Act
        bool isSuccess = ValidationHelper.UPNLengthValidator(upn);
        // Assert
    ...
    public void IsValidUpnRegularExpression_Check()
    {
        ...
        // Act
        bool isSuccess = ValidationHelper.UPNRegexValidator(upn);
        // Assert
        Assert.True(isSuccess);
    }
    ...
    public void IsValidUpnFormat_Check()
    {
        ...
        // Act
        bool isSuccess = ValidationHelper.IsValidUpn(upn);
        // Assert
        Assert.True(isSuccess);
    }
    ...
    public void IsValidUlnLength_Check()
    {
        ...
        // Act
        bool isSuccess = ValidationHelper.ULNLengthValidator(uln);
        // Assert
        Assert.True(isSuccess);
    }
    ...
    public void IsValidUlnRegularExpression_Check()
    {
        ...
        // Act
        bool isSuccess = ValidationHelper.ULNRegexValidator(uln);
        // Assert
        Assert.True(isSuccess);
    }
    ...
    public void IsValidUlnF_Check()
    {
        ...
        // Act
        bool isSuccess = ValidationHelper.IsValidUln(uln);
        // Assert
        Assert.True(isSuccess);
    }
    ...
    public void GetDuplicates_Given_List_Of_Ulns_Or_Upns_Returns_Duplicates()
    {
        ...
        // Act
        List<string> duplicates = ValidationHelper.GetDuplicates(listOfIdentifiers);
