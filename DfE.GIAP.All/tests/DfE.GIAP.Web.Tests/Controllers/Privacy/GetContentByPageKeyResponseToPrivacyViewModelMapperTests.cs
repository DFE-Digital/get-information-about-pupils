...
public sealed class GetContentByPageKeyResponseToPrivacyViewModelMapperTests
{
    [Fact]
    public void Mapper_Throws_When_Input_Is_Null()
    {
        // Arrange
        GetContentByPageKeyResponseToPrivacyViewModelMapper sut = new();
    ...
    [Fact]
    public void Mapper_Maps_PrivacyViewModel()
    {
        // Arrange
        ...
        // Act
        PrivacyViewModel response = sut.Map(contentResponse);
