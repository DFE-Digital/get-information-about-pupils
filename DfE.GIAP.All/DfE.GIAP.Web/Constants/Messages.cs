...
public static class Messages
{
    public static class Common
    {
        public static class Errors
        {
            ...
            public const string AdminTitleRequired = "Title must be entered";
            public const string AdminBodyRequired = "Body must be entered";
            public const string AdminDocumentRequired = "Please select a document";
            public const string AdminNewsArticleRequired = "Please select a news article";
            public const string AdminSecurityReportRequired = "A report must be selected";
            public const string AdminTitleLength = "Title must be must be 64 characters or fewer";
